      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            ...
            >
              <h3 className={`font-semibold ${plan.popular ? 'text-white' : 'text-gray-900'}`}>
                {plan.name}
              </h3>
              <div className="mt-2 mb-4">
                ...
                <span className={plan.popular ? 'text-primary-100' : 'text-gray-500'}>/mo</span>
              </div>
              <ul className={`space-y-2 text-sm mb-6 ${plan.popular ? 'text-primary-100' : 'text-gray-600'}`}>
